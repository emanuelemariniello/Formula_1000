...
gear_ratio = 2.4; %adapt to have z_driven integer
n_driven_shaft = n_driving_shaft/gear_ratio; %rpm driven shaft
z_driving = 15; %from gear ratio, minimum number of teeth
sigma_r = 900; %tensile strength Steel C60 - UNI EN 10083-2:2006 (n/mm2)
HB = 215; %Brinell hardness Steel C60 - UNI EN 10083-2:20064
...
Dimensions_1_gear_driving = [mn z_driving dp_driving df_driving da_driving db_driving b];
xlswrite('Gears.xlsx',Dimensions_1_gear_driving,'1_driving')
...
a = (dp_driven + dp_driving)/2; %wheel base
...
Dimensions_1_gear_driven = [mn z_driven dp_driven df_driven da_driven db_driven b a];
xlswrite('Gears.xlsx',Dimensions_1_gear_driven,'1_driven')
