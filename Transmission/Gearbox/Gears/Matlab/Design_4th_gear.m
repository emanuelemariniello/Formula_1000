...
gear_ratio = 21/30; %adapt to have z_driven integer
n_driven_shaft = n_driving_shaft/gear_ratio; %rpm driven shaft
z_driving = 30; %from gear ratio, minimum number of teeth
...
Dimensions_4_gear_driving = [mn z_driving dp_driving df_driving da_driving db_driving b];
xlswrite('Gears.xlsx',Dimensions_4_gear_driving,'4_driving')
...
Dimensions_4_gear_driven = [mn z_driven dp_driven df_driven da_driven db_driven b a];
xlswrite('Gears.xlsx',Dimensions_4_gear_driven,'4_driven')
