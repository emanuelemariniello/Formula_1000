...
pl.title("Shear chart of the " + str(Gear) + " Gear in the mainshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Shear [N]")
pl.grid(True)
pl.legend()
pl.savefig(".\Trasmission\Gearbox\Shafts\Python\Main_shaft\Shear_" + str(Gear) + "_gear_in_the_mainshaft.png")
pl.show()
...
pl.title("Traction chart on the mainshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Traction [N]")
pl.grid(True)
pl.legend()
pl.savefig(".\Trasmission\Gearbox\Shafts\Python\Main_shaft\Traction_chart.png")
pl.show()
...
pl.title("Torque chart on the mainshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Torque [Nmm]")
pl.grid(True)
pl.legend()
pl.savefig(".\Trasmission\Gearbox\Shafts\Python\Main_shaft\Torque_chart.png")
pl.show()
...
pl.title("Bending moment chart of the " + str(Gear) + " Gear in the mainshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Bending moment [N*mm]")
pl.grid(True)
pl.legend()
pl.savefig('.\Trasmission\Gearbox\Shafts\Python\Main_shaft\Bending moment_' + str(Gear) + '_gear_in_the_main_shaft.png')
pl.show()
...
print("The plots are saved in the following path: Trasmission\Gearbox\Shafts\Python\Main_shaft")
