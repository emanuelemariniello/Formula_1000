...
pl.title("Shear chart of the " + str(Gear) + " Gear - Layshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Shear [N]")
pl.grid(True)
pl.legend()
pl.savefig(".\Output\Shear_" + str(Gear) + "_gear_in_the_layshaft.png")
pl.show()
...
pl.title("Torque chart - Layshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Torque [Nmm]")
pl.grid(True)
pl.legend()
pl.savefig(".\Output\Torque_chart_layshaft.png")
pl.show()
...
pl.title("Bending moment chart of the " + str(Gear) + " Gear - Layshaft")
pl.xlabel("Lenght [mm]")
pl.ylabel("Bending moment [N*mm]")
pl.grid(True)
pl.legend()
pl.savefig('.\Output\Bending moment_' + str(Gear) + '_gear_in_the_layshaft.png')
pl.show()
