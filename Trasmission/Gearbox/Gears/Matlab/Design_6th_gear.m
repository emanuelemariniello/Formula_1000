...
gear_ratio = 0.5; %adapt to have z_driven integer
n_driven_shaft = n_driving_shaft/gear_ratio; %rpm driven shaft
n_driven_shaft_6th = n_driven_shaft;
z_driving = 34; %from gear ratio, minimum number of teeth
...
Dimensions_6_gear_driving = [mn z_driving dp_driving df_driving da_driving db_driving b];
xlswrite('Gears.xlsx',Dimensions_6_gear_driving,'6_driving')
...
Dimensions_6_gear_driven = [mn z_driven dp_driven df_driven da_driven db_driven b a];
xlswrite('Gears.xlsx',Dimensions_6_gear_driven,'6_driven') 
...
xlswrite('Loads.xlsx',Loads,'6th')

f = 0.015; %Friction coefficient for abundantly lubricated gears or in an oil bath
eff = 1-(f*pi*((1/z_driving)+(1/z_driven)));

save('Variables.mat','n_driving_shaft','Mt_engine', 'n_driven_shaft_6th')

% run Design_differential